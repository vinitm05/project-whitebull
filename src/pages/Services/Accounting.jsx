      ...
      <div className="my-8 px-4.5">
        ...
        <div>
          ...
          <p className="my-5 text-justify leading-7 text-gray-500">
            ...
            the best. Whether you’re a CA practice or a larger firm, we’re here
            to help you grow—offering scalable, flexible solutions to meet your
          ...
          <ul className="my-5 list-disc pl-7 text-justify leading-7 text-gray-500">
            ...
            <li>
              <span className="font-bold text-gray-600">Cost Savings:</span> Cut
              hiring costs while getting premium-quality accounting services
            </li>
            <li>
        ...
        <div>
          ...
          <p className="rounded-2xl bg-[#325271] px-8 py-9 text-xl text-white">
            Want to simplify your firm’s payables and receivables? Explore our{" "}
        ...
        <div>
            ...
            <ul className="my-5">
              ...
              <li className="grid auto-cols-auto grid-flow-col">
                ...
                <p className="ml-3">
                  ...
                  understand the unique challenges and regulations you face—and
                  we have the solutions to keep you ahead.
                </p>
              </li>
              <li className="grid auto-cols-auto grid-flow-col">
                <FaCheckCircle className="text-2xl text-[#2a4768]" />
          ...
          <p className="rounded-2xl bg-[#325271] px-8 py-9 text-xl text-white">
            ...
            to ensure your clients get the accurate and compliant filings they
            deserve.
          </p>
          <h2 className="my-5 text-4xl font-bold">
          ...
          <p className="my-5 text-gray-500">
            ...
            operations. Let us be the invisible part of your team that propels
          ...
          <p className="leading-7 text-gray-500">
            ...
            firm. From day-to-day accounting to complex financial planning, we
            help you{" "}
            <span className="font-bold text-gray-600">
          ...
          <ul className="text-gray-500">
            ...
            <li>👉 Book a Free Trial and experience hassle-free accounting!</li>
          </ul>
        </div>
      </div>
