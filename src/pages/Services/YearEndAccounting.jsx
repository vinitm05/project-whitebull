          ...
          <div className="my-8 px-4.5">
            <div>
              ...
              <p className="my-5 text-justify leading-7 text-gray-500">
                Year-end accounting season—also known as the time when
                accountants survive on coffee and tight deadlines. At Wisely
                Yours, we take the stress off your shoulders by providing
                outsourced year-end accounting services tailored specifically
                for CA and accounting firms in the India. From financial
                statement preparation to compliance checks and reconciliations,
                our experts ensure your client’s financials are accurate,
                compliant, and delivered on time.
              </p>

              <p className="my-5 text-justify leading-7 text-gray-500">
                <span className="font-semibold text-gray-600">Pan Point:</span>{" "}
                The year-end rush is no joke. With deadlines looming, tax
                adjustments to finalize, and compliance requirements to meet,
                accountants are often left juggling too many tasks at once. Any
                small error can lead to reporting issues, regulatory penalties,
                or frustrated clients.
              </p>

              <p className="my-5 text-justify leading-7 text-gray-500">
                The solution? Outsource your year-end accounting to Wisely
                Yours. We take care of the meticulous financial reviews,
                reconciliations, and reporting—so you don’t have to.
              </p>
            ...
            <div>
              ...
              <p className="my-5 text-justify leading-7 text-gray-500">
                We understand that year-end accounting isn’t just about
                crunching numbers—it’s about accuracy, compliance, and peace of
                mind. Here’s how we help:
              </p>

              <ul className="ml-10 list-disc text-gray-500">
                <li>
                  <span className="font-bold">Precise Financial Reports:</span>{" "}
                  We ensure every number adds up, reducing discrepancies and
                  potential red flags.
                </li>
                <li>
                  <span className="font-bold">Regulatory Compliance:</span> Our
                  team stays up-to-date with India accounting standards and HMRC
                  guidelines, ensuring all reports are audit-ready.
                </li>
                <li>
                  <span className="font-bold">Time-Saving Efficiency:</span> No
                  more last-minute scrambling—we streamline the process so you
                  can meet deadlines with ease.
                </li>
                <li>
                  <span className="font-bold">Expert Reconciliations:</span> We
                  reconcile accounts thoroughly to ensure your clients’
              ...
              <p className="my-6 rounded-2xl bg-[#325271] px-8 py-9 text-xl text-white">
                ...
                to ensure your firm’s financial records are maintained
                year-round with accuracy and efficiency.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="leading-6.5 text-gray-500">
                ...
                they meet India GAAP and other regulatory requirements. From
                balance sheets to profit & loss reports, we’ve got it covered.
              </p>
              ...
              <p className="leading-6.5 text-gray-500">
                We handle tax provisions, deferred tax calculations, and ensure
                all necessary adjustments are made in compliance with HMRC
                regulations.
              </p>
              ...
              <p className="leading-6.5 text-gray-500">
                We ensure that accounts are finalized accurately, making your
                firm’s year-end reporting process seamless.
              </p>
            ...
            <div>
              ...
              <p className="my-5 text-justify leading-7 text-gray-500">
                <span className="font-semibold text-gray-600">Pan Point:</span>{" "}
                The Many firms struggle with last-minute reconciliations,
                reporting errors, and compliance risks, leading to unnecessary
                stress.
              </p>
            ...
            <div>
              ...
              <p className="my-5 text-justify leading-7 text-gray-500">
                Year-end accounting doesn’t have to be a headache. Let Wisely
                Yours handle the nitty-gritty details while you focus on serving
                your clients and scaling your firm.
              </p>

              <p className="mt-6 mb-16 font-bold text-gray-500">
                📞 Ready to streamline your year-end accounting? Get in touch
                today and let’s make this season stress-free! 🚀
              </p>
            </div>
          </div>
        </div>
