          ...
          <div className="my-8 px-4.5">
            <div>
              ...
              <p className="my-5 text-justify leading-7 text-gray-500">
                Managing bookkeeping in-house can be overwhelming,
                time-consuming, and expensive. As your firm grows, handling
                increasing transactions, reconciliations, and compliance
                requirements can lead to errors, missed deadlines, and potential
                risks.
              </p>

              <p className="my-5 text-justify leading-7 text-gray-500">
                We specialize in outsourced bookkeeping services tailored for CA
                and accounting firms in the India. Our expert team ensures
                accurate financial records, seamless reconciliations, and full
                compliance with India accounting standards—so your firm can
                focus on delivering high-value services to clients.
              </p>
              <p className="my-5 text-justify font-bold text-gray-500">
                🚀 Reduce costs, boost efficiency, and gain financial clarity
              ...
              <p className="my-5 text-justify leading-7 text-gray-500">
                ...
                handling your bookkeeping, your firm avoids these pitfalls,
                keeping client records accurate, organized, and timely.
              </p>
              <p className="my-6 rounded-2xl bg-[#325271] px-8 py-9 text-xl text-white">
                Looking to improve your firm’s overall financial management?
                Explore our{" "}
            ...
            <div>
              ...
              <p className="leading-6.5 text-gray-500">
                Outsourcing your bookkeeping to Wisely Yours eliminates the
                overhead costs of hiring and managing an in-house team. Our
                flexible services adapt to your firm’s growth, allowing you to
              ...
              <p className="leading-6.5 text-gray-500">
                With real-time data entry, automated reconciliations, and
                meticulous financial tracking, we help your firm maintain
                precision in bookkeeping. Our expert team ensures that all
                transactions are accurately recorded, reducing the risk of
                discrepancies.
              </p>
              <h2 className="my-3.5 text-2xl font-bold">
                {" "}
              ...
              <p className="my-5 text-justify leading-7 font-bold text-gray-500">
                💡 Partner with Wisely Yours and experience a bookkeeping
                solution that is efficient, accurate, and tailored to your
                firm’s needs.
              </p>
            ...
            <div>
              ...
              <ul className="py-5 text-gray-500">
                <li>
                  ✔ Identify and correct discrepancies before they impact
                  financial reporting.
                </li>
                <li>
                  ✔ Keep financial records audit-ready and fully reconciled.
                </li>
              </ul>

              {/* 3 */}
              <h3 className="text-2xl font-bold">
                GST & Tax-Ready Bookkeeping
              </h3>
              <ul className="py-5 text-gray-500">
                <li>
              ...
              <p className="mb-5 leading-7 text-gray-500">
                Over the years, we’ve helped India accounting firms optimize
                their bookkeeping processes, ensuring that client accounts
                remain accurate and compliant. By choosing Wisely Yours, your
                firm will have the confidence of knowing all financial records
                are in good hands.
              </p>
              ...
              <p className="text-gray-500">
                With years of experience in outsourced accounting, Wisely Yours
                is the trusted partner for India CA and accounting firms. Our
                services enhance efficiency, accuracy, and cost-effectiveness,
                helping firms streamline their bookkeeping and focus on client
                advisory services.
              </p>
              <ul className="my-6 text-gray-500">
                ...
                <li>
                  ...
                  – Get a team of skilled bookkeepers working exclusively for
                  your firm.
                </li>
                <li>
                  🔹 <span className="font-bold">Proven Track Record</span> –
                  We’ve helped India firms optimize their bookkeeping processes
                  with flawless financial management.
                </li>
              </ul>

              <p className="font-bold text-gray-500">
                💡 Outsource your bookkeeping to Wisely Yours and transform the
                way your firm manages financial records!
              </p>
              ...
              <p className="text-gray-500">
                Our outsourced bookkeeping services are designed to help India
                CA and accounting firms improve accuracy, efficiency, and
                compliance. Whether you need help with day-to-day bookkeeping,
                reconciliations, or GST-ready financial records, Wisely Yours
                provides expert support to keep your clients’ accounts in
                perfect order.
              </p>
              <p className="mt-6 mb-16 font-bold text-gray-500">
                📩 Get in touch today to discover how Wisely Yours can
                streamline your bookkeeping and enhance your firm’s
                productivity!
              </p>
            </div>
          </div>
