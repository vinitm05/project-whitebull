      ...
      <div className="px-5 py-5">
        <div>
          <h2 className="text-left text-4xl font-bold">
            <span className="text-[#2a4768]">Expert Payroll Solutions </span>for
            Your Clients’ Needs
          </h2>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <span className="font-bold">
              {" "}
              statutory deductions, pension contributions, or HMRC filings,{" "}
            </span>
            we handle it all
        ...
        <div>
          ...
          <ul className="mt-4 mb-5 text-justify text-gray-500">
            <li className="list-disc">
              <span className="font-bold">✅ Accuracy & Compliance: </span>No
              more last-minute tax panic—we ensure error-free payroll processing
              and HMRC compliance.
            </li>
            <li className="list-disc">
              <span className="font-bold">💰 Cost-Effective: </span>No need for
              an in-house payroll department—save time, money, and headaches.
            </li>
            <li className="list-disc">
              <span className="font-bold">📈 Scalable Solutions: </span>Whether
              you manage payroll for{" "}
              <span className="font-bold"> 5 clients or 500 </span>our services
              grow with you.
            </li>
            <li className="list-disc">
          ...
          <p className="mb-10 rounded-2xl bg-[#2a4768] px-8 py-10 text-lg text-white">
            ...
            <span className="font-bold"> Tax Preparation Services </span>to help
            your clients stay compliant and optimize their tax strategies.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <span className="font-bold"> reliable, professional support </span>
            with:
          </p>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            ...
            calculations.<br></br>
            <span className="font-bold">✔ Statutory deductions </span>(National
            Insurance, pensions, student loans).<br></br>
            <span className="font-bold">✔ HMRC compliance </span>& tax filing.
            <br></br>
            <span className="font-bold">✔ Payslip generation </span>& payroll
            reports.<br></br>
            <span className="font-bold">
        ...
        <div>
          <h2 className="text-left text-4xl font-bold">
            <span className="text-[#2a4768]">The Real Pain Point: </span>Payroll
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <span className="font-bold"> costly and legally risky. </span>Late
            filings? Incorrect deductions?
            <span className="font-bold">
              {" "}
          ...
          <ul className="mt-4 mb-5 text-justify text-gray-500">
            <li className="list-disc">
              <span className="font-bold">No miscalculations— </span>so clients
              don’t come knocking.
            </li>
            <li className="list-disc">
        ...
        <div>
          ...
          <ul className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <li>
              <span className="font-bold">📌 Fully Scalable: </span>Whether you
              have
              <span className="font-bold">
                {" "}
            ...
            <li>
              <span className="font-bold">📌 End-to-End Payroll Support: </span>
        ...
        <div>
          ...
          <ul className="mt-4 mb-5 text-justify text-gray-500">
            <li>
              <span className="font-bold">🚀 100% Payroll Accuracy – </span>No
              miscalculations, no delays.
            </li>
            <li>
              <span className="font-bold">🚀 Timely Payments – </span>Employees
              paid on time, every time.
            </li>
            <li>
              <span className="font-bold">🚀 HMRC Compliance – </span>Every tax,
              deduction, and filing done
        ...
        <div>
          ...
          <p className="mb-10 rounded-2xl bg-[#2a4768] px-8 py-10 text-lg text-white">
            Interested in other services to support your firm? Learn more about
            our
            <span className="font-bold"> Outsourced Accounting Services </span>
