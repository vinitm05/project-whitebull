      ...
      <div className="bg-[#eceef6] px-33 py-30">
        <div>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <span className="font-bold"> time-consuming and complex. </span>As
            an accounting firm, your clients expect
            <span className="font-bold"> clear financial insights </span>that
        ...
        <div>
          ...
          <h3 className="text-left text-3xl font-bold">Here’s why it works:</h3>
          ...
          <ul className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <li>
              <span className="font-bold">✅ Cost-Effective </span>– Get expert
              insights without hiring a full-time analyst.
            </li>
            <li>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            <span className="font-bold">Bottom Line: </span>We help you deliver
        ...
        <div>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            We offer
            <span className="font-bold"> data-driven financial analysis </span>
            designed to help your clients optimize business performance.
          </p>

          <h3 className="text-left text-3xl font-bold">Our Key Services:</h3>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            ...
            —so you can
            <span className="font-bold"> deliver high-value insights </span>to
            your clients.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            ...
            when you can let experts handle it? Outsourcing allows you to focus
            on client relationships, advisory services, and
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <span className="font-bold"> clear financial insights, </span>they
            trust you more. We help you
        ...
        <div>
          ...
          <ul className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <li>
              ...
              Work with
              <span className="font-bold"> finance professionals </span>without
              hiring in-house.
            </li>
            <li>
              <span className="font-bold">🔹 ISO-Certified Security </span>–
              Your
              <span className="font-bold"> client data stays 100% secure.</span>
            </li>
            <li>
        ...
        <div>
          ...
          <p className="mt-4 mb-5 text-justify text-gray-500">
            Your clients
            <span className="font-bold"> rely on financial insights </span>to
            make business decisions. But without
          ...
          <ul className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <li>
              🔹 Offer
              <span className="font-bold"> value-added advisory services.</span>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 mb-5 text-justify text-gray-500">
            ...
            <li>
              <span className="font-bold">🔹 Enhance client trust </span>with
